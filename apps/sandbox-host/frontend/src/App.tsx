      ...
      >
        ...
        >
          ...
          <nav style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <select value={role} onChange={(e) => switchRole(e.target.value as SandboxRole)}>
  ...
  return (
    <>
      ...
      <p style={{ maxWidth: 640 }}>
        This is a minimal demo host that mounts <code>@rl3/feedback-widget</code> with header-driven
        fake auth. Toggle the role in the top-right to switch between <em>staff</em> (can submit),{" "}
        <em>manager</em>, and <em>admin</em> (can triage). Click the floating RL3 button to open the
        feedback panel.
      </p>
      <p style={{ maxWidth: 640 }}>
        After submitting feedback, switch to <strong>admin</strong>, open{" "}
        <strong>Admin triage</strong>, and walk it through the lifecycle. Email notifications land
        in MailHog at{" "}
