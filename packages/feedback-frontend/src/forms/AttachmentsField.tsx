...
export function AttachmentsField({
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="feedback-attachments" title={t("feedback.attachments.hint")}>
      ...
      >
        ...
        <p className="mt-1 text-[11px] text-muted-foreground">{t("feedback.attachments.hint")}</p>
        <input
          ref={inputRef}
          ...
          {value.map((file, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[11px] text-muted-foreground">{_formatBytes(file.size)}</span>
                <button
                  type="button"
