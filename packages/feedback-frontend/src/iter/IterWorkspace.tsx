...
function WorkingDocument({ markdown }: { markdown: string }) {
  ...
  // Self-contained typography styles. The widget can't depend on
  // @tailwindcss/typography being installed in the host; using
  // arbitrary-variant selectors keeps the styles in our bundle.
  return (
    <article
      ref={ref}
      className={[
