...
import { type FeedbackAdapter, type FeedbackHostBindings, createAdapter } from "./adapter";
...
const _ENV_ENABLED =
  (import.meta.env.VITE_FEEDBACK_ENABLED ?? "true").toString().toLowerCase() !== "false";
...
export function FeedbackProvider({ children, bindings, adapter, config }: FeedbackProviderProps) {
