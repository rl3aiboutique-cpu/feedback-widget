...
import { useEffect as useEffect4, useMemo as useMemo3, useRef as useRef5, useState as useState6 } from "react";
...
import { Check as Check2, Loader2 as Loader22 } from "lucide-react";
    ...
    "section",
    {
      ...
      children: [
            ...
            children: [
              ...
              status === "done" ? /* @__PURE__ */ jsxs3(
                "span",
                {
                  ...
                  style: { fontSize: "0.65rem" },
                  children: [
                    /* @__PURE__ */ jsx3(Check2, { className: "h-3 w-3" }),
                    "listo"
                  ]
                }
              ) : null
        ...
        status === "pending" ? /* @__PURE__ */ jsxs3(
          ...
          /* @__PURE__ */ jsx3("div", { className: "p-3 italic text-muted-foreground", style: { fontSize: "0.7rem" }, children: "Esta versi\xF3n del spec no incluye contenido para esta secci\xF3n." })
        ) : /* @__PURE__ */ jsx3(
          "article",
          {
            ref: bodyRef,
...
function RenderedMarkdown({
  ...
  return /* @__PURE__ */ jsx4("article", { ref, className: className ?? _DOC_TYPOGRAPHY });
}
...
function ThinkingDots() {
  return /* @__PURE__ */ jsxs4("span", { "aria-hidden": "true", className: "inline-flex items-end gap-1", children: [
    /* @__PURE__ */ jsx4("span", { className: "inline-block h-1.5 w-1.5 animate-bounce rounded-full bg-primary [animation-delay:0ms]" }),
    /* @__PURE__ */ jsx4("span", { className: "inline-block h-1.5 w-1.5 animate-bounce rounded-full bg-primary [animation-delay:150ms]" }),
    /* @__PURE__ */ jsx4("span", { className: "inline-block h-1.5 w-1.5 animate-bounce rounded-full bg-primary [animation-delay:300ms]" })
  ] });
}
function StreamingSkeleton({
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "flex-1 space-y-5 overflow-auto rounded-lg border bg-card p-6 text-sm", children: [
    /* @__PURE__ */ jsxs4("div", { className: "rounded-md border border-primary/30 bg-primary/5 p-4", children: [
      /* @__PURE__ */ jsxs4("p", { className: "flex items-center gap-2 font-medium text-primary", children: [
        /* @__PURE__ */ jsx4(Loader23, { className: "h-4 w-4 animate-spin shrink-0" }),
        /* @__PURE__ */ jsx4("span", { className: "leading-snug", children: heading }),
        /* @__PURE__ */ jsx4(ThinkingDots, {})
      ] }),
      /* @__PURE__ */ jsx4("p", { className: "mt-1 min-h-[1.25rem] text-xs text-muted-foreground transition-opacity", children: message }),
      /* @__PURE__ */ jsxs4("p", { className: "mt-2 text-[11px] text-muted-foreground/80", children: [
        modelHint,
    ...
    _SECTION_SKELETONS.map((s, idx) => {
      ...
      return /* @__PURE__ */ jsxs4("div", { className: `rounded-md border p-4 transition-colors ${cardClass}`, children: [
        /* @__PURE__ */ jsxs4("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx4("h4", { className: `text-base font-semibold ${titleClass}`, children: s.heading }),
          isActive && /* @__PURE__ */ jsx4("span", { className: "text-xs text-primary", children: "writing now\u2026" }),
          isPast && /* @__PURE__ */ jsx4("span", { className: "text-xs text-emerald-700", children: "done" })
        ] }),
        /* @__PURE__ */ jsx4("p", { className: "mb-3 text-xs text-muted-foreground", children: s.hint }),
        /* @__PURE__ */ jsxs4("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx4("div", { className: `h-3 w-[85%] rounded ${barBaseClass}` }),
          /* @__PURE__ */ jsx4("div", { className: `h-3 w-[70%] rounded ${barBaseClass}` }),
          /* @__PURE__ */ jsx4("div", { className: `h-3 w-[92%] rounded ${barBaseClass}` })
        ] })
      ] }, s.key);
    })
  ] });
...
import { useCallback, useRef as useRef4, useState as useState5 } from "react";
var _INIT = {
  status: "idle",
  partialMarkdown: "",
  activeSection: null,
...
function useIterRunStream(bindings, sessionId) {
  const [state, setState] = useState5(_INIT);
...
function IterWorkspace({ sessionId, onClose }) {
  ...
  const [tab, setTab] = useState6("document");
  const [seenAssumptionsBadge, setSeenAssumptionsBadge] = useState6(false);
  useEffect4(() => {
    if (!seenAssumptionsBadge && openAssumptionCount > 0 && tab === "document") {
    }
  }, [openAssumptionCount, tab, seenAssumptionsBadge]);
  return /* @__PURE__ */ jsxs6("div", { className: "fixed inset-0 z-[60] flex flex-col bg-background text-foreground", children: [
    /* @__PURE__ */ jsx6(
      Header,
      {
    ...
    /* @__PURE__ */ jsxs6("div", { className: "flex-1 min-h-0 overflow-y-auto", children: [
      tab === "document" && /* @__PURE__ */ jsx6(
        DocumentTab,
        {
      ...
      tab === "activity" && /* @__PURE__ */ jsx6(ActivityTab, { versions: versions.data ?? [] })
    ] }),
    /* @__PURE__ */ jsx6(
      Footer,
      {
...
function Header(props) {
  return /* @__PURE__ */ jsxs6("header", { className: "flex items-center gap-3 border-b bg-card px-4 py-2 text-sm", children: [
    /* @__PURE__ */ jsx6("span", { className: "font-semibold", children: "Iterate with AI" }),
    /* @__PURE__ */ jsx6("span", { className: "rounded bg-muted px-2 py-0.5 text-xs text-muted-foreground", children: props.session?.status ?? "loading" }),
    /* @__PURE__ */ jsxs6("span", { className: "hidden text-xs text-muted-foreground md:inline", children: [
      "model: ",
      _resolveDisplayModel(props.session)
    ] }),
    props.streaming && /* @__PURE__ */ jsxs6("span", { className: "flex items-center gap-1.5 text-xs text-primary", children: [
      /* @__PURE__ */ jsx6(Loader24, { className: "h-3 w-3 animate-spin" }),
      props.streamSection ? `Writing ${props.streamSection.replace("_", " ")}\u2026` : "AI is thinking\u2026"
    ] }),
    props.totalCount > 0 && /* @__PURE__ */ jsxs6("div", { className: "ml-2 hidden items-center gap-2 md:flex", children: [
      ...
      /* @__PURE__ */ jsx6("div", { className: "h-1.5 w-24 overflow-hidden rounded-full bg-muted", children: /* @__PURE__ */ jsx6(
        "div",
        {
    ...
    /* @__PURE__ */ jsxs6("div", { className: "ml-auto flex items-center gap-2", children: [
      !props.terminal && props.onAbandon && /* @__PURE__ */ jsx6(Button, { size: "sm", variant: "ghost", onClick: props.onAbandon, children: "Discard session" }),
      props.onClose && /* @__PURE__ */ jsx6(Button, { size: "sm", variant: "outline", onClick: props.onClose, children: "Close" })
    ] })
  ] });
}
function TabBar(props) {
  ...
  return /* @__PURE__ */ jsx6("div", { className: "flex items-center gap-1 border-b bg-card px-3", role: "tablist", children: tabs.map((t) => {
...
function DocumentTab(props) {
  return /* @__PURE__ */ jsxs6("div", { className: "mx-auto flex w-full max-w-[1400px] flex-row gap-6 p-4 lg:p-6", children: [
    props.markdown && !props.streaming && /* @__PURE__ */ jsx6(DocumentTOC, { markdown: props.markdown }),
    /* @__PURE__ */ jsxs6("main", { className: "flex flex-1 flex-col", children: [
      !props.latestVersion && props.streamStatus === "idle" && /* @__PURE__ */ jsx6(FirstRunCard, { busy: false, onRun: props.onFirstRun }),
      /* @__PURE__ */ jsx6(
        EditableSpecPanel,
        {
      ...
      props.streamStatus === "error" && /* @__PURE__ */ jsx6(ErrorBanner, { code: props.streamErrorCode, message: props.streamErrorMessage })
    ] })
  ] });
}
function DocumentTOC({ markdown }) {
  ...
  return /* @__PURE__ */ jsx6("aside", { className: "hidden w-56 shrink-0 lg:block", children: /* @__PURE__ */ jsxs6("div", { className: "sticky top-2", children: [
    /* @__PURE__ */ jsx6("h4", { className: "mb-2 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground", children: "On this page" }),
    /* @__PURE__ */ jsx6("ul", { className: "space-y-1 text-sm", children: headings.map((h) => /* @__PURE__ */ jsx6("li", { className: h.level === 2 ? "ml-3 text-xs text-muted-foreground" : "", children: /* @__PURE__ */ jsx6(
      "a",
      {
        href: `#${h.id}`,
...
function AssumptionsTab(props) {
  return /* @__PURE__ */ jsx6("div", { className: "mx-auto w-full max-w-[1600px] p-4 lg:p-6", children: /* @__PURE__ */ jsx6(AssumptionsGrid, { items: props.items, onResolve: props.onResolve, disabled: props.disabled }) });
}
function ActivityTab({ versions }) {
  return /* @__PURE__ */ jsxs6("div", { className: "mx-auto w-full max-w-[1100px] p-4 lg:p-6", children: [
    /* @__PURE__ */ jsx6("h3", { className: "mb-3 text-sm font-semibold", children: "Iteration history" }),
    /* @__PURE__ */ jsx6(ActivityTimeline, { versions })
  ] });
}
function Footer(props) {
  const [msg, setMsg] = useState6("");
  const [restructure, setRestructure] = useState6(false);
  const status = props.session?.status;
  if (status === "finalized") {
    return /* @__PURE__ */ jsx6("footer", { className: "border-t bg-card px-4 py-3 text-sm", children: /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx6("span", { className: "font-semibold", children: "Session finalized." }),
      props.package?.presigned_zip_url && /* @__PURE__ */ jsx6("a", { href: props.package.presigned_zip_url, className: "text-primary underline", download: true, children: "Download package ZIP" })
    ] }) });
  }
  if (status === "abandoned") {
    return /* @__PURE__ */ jsx6("footer", { className: "border-t bg-card px-4 py-3 text-sm text-muted-foreground", children: "Session abandoned." });
  }
  ...
  const [showFinalizeWarning, setShowFinalizeWarning] = useState6(false);
  ...
  return /* @__PURE__ */ jsxs6("footer", { className: "space-y-2 border-t bg-card px-4 py-3", children: [
    props.needsReviewIteration && /* @__PURE__ */ jsxs6("div", { className: "rounded-md border border-emerald-300 bg-emerald-50 px-3 py-2 text-xs text-emerald-900 dark:border-emerald-800 dark:bg-emerald-900/20 dark:text-emerald-200", children: [
      /* @__PURE__ */ jsx6("p", { className: "font-semibold", children: "All assumptions resolved." }),
      /* @__PURE__ */ jsxs6("p", { children: [
        "Add a comment below if you want, then press ",
        /* @__PURE__ */ jsx6("strong", { children: "Run iteration" }),
    ...
    /* @__PURE__ */ jsxs6("div", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ jsxs6("label", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsx6(
          "input",
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ jsxs6("div", { className: "ml-auto flex gap-2", children: [
        /* @__PURE__ */ jsx6(
          Button,
          {
    ...
    props.openAssumptions > 0 && status !== "draft" && /* @__PURE__ */ jsxs6("p", { className: "text-xs text-amber-700", children: [
      "Resolve all ",
      props.openAssumptions,
      " open assumption(s) before iterating."
    ] }),
    showFinalizeWarning && /* @__PURE__ */ jsx6(
  ...
  return /* @__PURE__ */ jsxs6(
    "dialog",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx6("p", { className: "text-sm text-muted-foreground", children: "The dev team interprets the package as the source of truth. If you finalize now, the following items aren't fully clarified:" }),
        /* @__PURE__ */ jsxs6("ul", { className: "mt-3 list-disc space-y-1 pl-5 text-sm", children: [
          props.openAssumptions > 0 && /* @__PURE__ */ jsxs6("li", { children: [
            /* @__PURE__ */ jsx6("strong", { children: props.openAssumptions }),
            " assumption",
            props.openAssumptions === 1 ? " is" : "s are",
            " still open and will be packaged as",
            " ",
            /* @__PURE__ */ jsx6("em", { children: "unresolved" }),
            "."
          ] }),
          props.needsReviewIteration && /* @__PURE__ */ jsx6("li", { children: "You haven't run a review iteration since resolving assumptions, so the working document doesn't reflect your answers yet." }),
          !props.hasAnyVersion && /* @__PURE__ */ jsx6("li", { children: "The session has no version yet \u2014 there's nothing to package." })
        ] }),
        /* @__PURE__ */ jsx6("p", { className: "mt-3 text-xs text-muted-foreground", children: "You can still finalize \u2014 useful when you'd rather hand off a partial spec than block on perfection. The dev team can ask follow-ups." }),
        /* @__PURE__ */ jsxs6("div", { className: "mt-5 flex justify-end gap-2", children: [
          /* @__PURE__ */ jsx6(Button, { variant: "outline", size: "sm", onClick: props.onCancel, children: "Cancel \u2014 I'll keep iterating" }),
          /* @__PURE__ */ jsx6(
            Button,
            {
              variant: "destructive",
...
function ActivityTimeline({ versions }) {
  if (!versions.length) {
    return /* @__PURE__ */ jsx6("p", { className: "text-xs text-muted-foreground", children: "No iterations yet." });
  }
  return /* @__PURE__ */ jsx6("ol", { className: "space-y-2", children: versions.map((v) => /* @__PURE__ */ jsxs6("li", { className: "rounded border bg-card p-2 text-xs", children: [
    /* @__PURE__ */ jsxs6("div", { className: "font-semibold", children: [
      "v",
      v.version_number
    ] }),
    /* @__PURE__ */ jsx6("div", { className: "text-muted-foreground", children: new Date(v.created_at).toLocaleString() }),
    v.user_message && /* @__PURE__ */ jsx6("div", { className: "mt-1 text-foreground/80 line-clamp-2", children: v.user_message }),
    v.restructure_allowed && /* @__PURE__ */ jsx6("span", { className: "mt-1 inline-block rounded bg-orange-100 px-1.5 py-0.5 text-[10px] text-orange-900", children: "restructure" })
  ] }, v.id)) });
}
var _KIND_BAND = {
  technical: {
...
function AssumptionsGrid(props) {
  if (!props.items.length) {
    return /* @__PURE__ */ jsx6("p", { className: "text-xs text-muted-foreground", children: "No assumptions on the current version yet." });
  }
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "space-y-4", children: [
    _KIND_ORDER.map((kind) => {
      ...
      return /* @__PURE__ */ jsxs6("section", { children: [
        /* @__PURE__ */ jsxs6("div", { className: "mb-1.5 flex items-center gap-2", children: [
          /* @__PURE__ */ jsx6("span", { className: `inline-block h-2 w-2 rounded-full ${dotColor}` }),
          /* @__PURE__ */ jsx6("h4", { className: "text-[11px] font-semibold uppercase tracking-wide text-muted-foreground", children: meta.name }),
          /* @__PURE__ */ jsx6("span", { className: "rounded-full bg-muted px-1.5 py-0.5 text-[10px] text-muted-foreground", children: items.length })
        ] }),
        /* @__PURE__ */ jsx6("div", { className: "grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4", children: items.map((a) => /* @__PURE__ */ jsx6("div", { className: `rounded-md border-l-4 ${meta.band} [&>div]:border-l-0`, children: /* @__PURE__ */ jsx6(
          AssumptionCard,
          {
            assumption: a,
    ...
    userFacingDone.length > 0 && /* @__PURE__ */ jsxs6("details", { className: "rounded border bg-muted/40 p-3", open: true, children: [
      /* @__PURE__ */ jsxs6("summary", { className: "cursor-pointer text-xs font-semibold", children: [
        "Resolved (",
        userFacingDone.length,
        ")"
      ] }),
      /* @__PURE__ */ jsx6("div", { className: "mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4", children: userFacingDone.map((a) => {
        const meta = _KIND_BAND[a.kind];
        return /* @__PURE__ */ jsx6("div", { className: `rounded-md border-l-4 ${meta.band} [&>div]:border-l-0`, children: /* @__PURE__ */ jsx6(
          AssumptionCard,
          {
            assumption: a,
            disabled: props.disabled,
    ...
    internalNotes.length > 0 && /* @__PURE__ */ jsxs6("details", { className: "rounded border border-blue-200 bg-blue-50/40 p-3 dark:border-blue-900 dark:bg-blue-900/10", children: [
      /* @__PURE__ */ jsxs6("summary", { className: "cursor-pointer text-xs font-semibold text-blue-900 dark:text-blue-200", children: [
        "AI-internal notes (",
        internalNotes.length,
        ") \u2014 no action required"
      ] }),
      /* @__PURE__ */ jsx6("p", { className: "mt-2 text-[11px] text-muted-foreground", children: "These are notes the AI is leaving for the downstream developer agent that will read your finalized package. They describe implementation details (architecture, code patterns, framework choices) that you wouldn't typically know \u2014 they ship with the package automatically." }),
      /* @__PURE__ */ jsx6("ul", { className: "mt-3 space-y-2", children: internalNotes.map((a) => /* @__PURE__ */ jsxs6(
        "li",
        {
          className: "rounded border border-blue-200 bg-white/60 p-2 text-xs dark:border-blue-900/50 dark:bg-blue-950/20",
          children: [
            /* @__PURE__ */ jsx6("div", { className: "font-medium text-foreground/90", children: a.statement }),
            a.rationale && /* @__PURE__ */ jsx6("div", { className: "mt-1 text-muted-foreground", children: a.rationale })
          ]
        },
        a.id
      )) })
...
function FirstRunCard({ busy, onRun }) {
  return /* @__PURE__ */ jsxs6("div", { className: "mb-3 rounded-md border bg-muted/40 p-4 text-sm", children: [
    /* @__PURE__ */ jsx6("p", { className: "mb-2", children: "The AI will read your feedback, attachments, and technical metadata, then propose user personas, user stories, a spec, and a list of every assumption it had to make. You will resolve those assumptions before iterating again." }),
    /* @__PURE__ */ jsx6(Button, { onClick: onRun, disabled: busy, children: "Generate first version" })
  ] });
}
function ErrorBanner(props) {
  return /* @__PURE__ */ jsxs6("div", { className: "mt-2 rounded border border-destructive/60 bg-destructive/10 p-3 text-sm text-destructive", children: [
    /* @__PURE__ */ jsxs6("div", { className: "font-semibold", children: [
      "Error: ",
      props.code
    ] }),
    /* @__PURE__ */ jsx6("div", { className: "mt-1 text-xs", children: props.message })
  ] });
}
...
function IterWorkspaceNamed(props) {
  return /* @__PURE__ */ jsx6(IterWorkspace, { ...props });
}
...
//# sourceMappingURL=IterWorkspace-ZMBPG3TW.js.map