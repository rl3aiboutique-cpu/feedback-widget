...
import { useCallback as useCallback2, useEffect as useEffect6, useRef as useRef5, useState as useState7 } from "react";
...
import { useEffect as useEffect5, useMemo as useMemo5, useRef as useRef4, useState as useState6 } from "react";

// src/iter/IterFocusShell.tsx
import { jsx as jsx6, jsxs as jsxs5 } from "react/jsx-runtime";
function IterFocusShell({ sidebar, main, rail }) {
  return /* @__PURE__ */ jsx6("div", { className: "@container/focus min-h-0 flex-1", children: /* @__PURE__ */ jsxs5(
    "div",
    {
      className: [
        "h-full grid gap-3",
      ...
      children: [
        /* @__PURE__ */ jsx6("div", { className: "[grid-area:sidebar] min-w-0 min-h-0 flex flex-col overflow-hidden", children: sidebar }),
        /* @__PURE__ */ jsx6("div", { className: "[grid-area:main] min-w-0 min-h-0 flex flex-col overflow-hidden", children: main }),
        /* @__PURE__ */ jsx6("div", { className: "[grid-area:rail] min-w-0 min-h-0 flex flex-col overflow-hidden", children: rail })
      ]
    }
  ) });
}
...
function IterMetadataRail({
  ...
  return /* @__PURE__ */ jsxs7(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs7("div", { className: "rounded-md border border-input bg-card px-2 py-1.5 text-[0.7rem]", children: [
          /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-2", children: [
            showRoundBadge ? /* @__PURE__ */ jsxs7(
              "span",
              {
            ...
            modelBadgeSlot ?? /* @__PURE__ */ jsxs7("span", { className: "text-muted-foreground", style: { fontSize: "0.65rem" }, children: [
              /* @__PURE__ */ jsx8("span", { "aria-hidden": "true", children: "\u26A1" }),
              " modelo \u2014"
            ] }),
            /* @__PURE__ */ jsx8("span", { className: "ml-auto", style: { fontSize: "0.65rem" }, children: elapsedTimerSlot ?? null })
          ] }),
          hintSlot ? /* @__PURE__ */ jsx8("div", { className: "mt-1 text-muted-foreground", style: { fontSize: "0.6rem" }, children: hintSlot }) : null
        ] }),
        toastLandingSlot ? /* @__PURE__ */ jsx8("div", { children: toastLandingSlot }) : null,
        /* @__PURE__ */ jsx8(
          IterContextPanel,
          {
            feedback,
...
function IterPendingSidebar({
  ...
  const [focusIdx, setFocusIdx] = useState5(initialFocusIdx);
  useEffect4(() => {
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "flex h-full min-h-0 flex-col overflow-hidden rounded-md border border-input bg-card", children: [
    /* @__PURE__ */ jsxs8("div", { className: "sticky top-0 z-10 border-b border-input bg-card/95 px-3 py-2 text-[0.7rem] font-semibold uppercase tracking-wide text-primary backdrop-blur supports-[backdrop-filter]:bg-card/80", children: [
    ...
    /* @__PURE__ */ jsx9(
      "div",
      {
        ...
        children: items.length === 0 ? /* @__PURE__ */ jsx9("p", { className: "px-1 py-3 text-center text-[0.7rem] text-muted-foreground", children: "Nada pendiente." }) : items.map((a, i) => {
    ...
    /* @__PURE__ */ jsxs8("details", { className: "border-t border-input", children: [
      /* @__PURE__ */ jsxs8("summary", { className: "cursor-pointer select-none px-3 py-1.5 text-[0.7rem] font-medium hover:bg-accent", children: [
        /* @__PURE__ */ jsx9("span", { children: "Resueltas" }),
        " ",
        /* @__PURE__ */ jsx9(
          "span",
          {
      ...
      /* @__PURE__ */ jsx9("div", { className: "max-h-[40vh] overflow-auto border-t border-input px-2 py-2 space-y-1", children: resolvedAssumptions.length === 0 ? /* @__PURE__ */ jsx9(
        "p",
        {
      ...
      ) : resolvedAssumptions.map((a) => /* @__PURE__ */ jsxs8(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx9("p", { className: "mt-0.5 line-clamp-2", children: a.statement })
          ]
        },
        a.id
      )) })
...
${a.rationale}`;
  ...
  const [selectedAssumptionId, setSelectedAssumptionId] = useState6(null);
  useEffect5(() => {
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "flex h-full flex-col gap-3", "data-feedback-id": "iter.focus-view", children: [
    /* @__PURE__ */ jsxs9("header", { className: "flex items-center gap-2 border-b border-input pb-2", children: [
      /* @__PURE__ */ jsxs9(Button, { size: "sm", variant: "ghost", onClick: onExit, className: "-ml-2 h-7 px-2", children: [
        /* @__PURE__ */ jsx10(ArrowLeft, { className: "h-3.5 w-3.5" }),
        " Volver"
      ] }),
      /* @__PURE__ */ jsx10(
        "code",
    ...
    session.error ? /* @__PURE__ */ jsxs9("div", { className: "rounded border border-destructive/60 bg-destructive/10 p-2 text-[11px] text-destructive", children: [
      /* @__PURE__ */ jsx10("strong", { className: "font-semibold", children: "Couldn't load this session." }),
      " ",
      String(session.error.message ?? session.error)
    ] }) : null,
    showAutoFireBanner ? /* @__PURE__ */ jsxs9("div", { className: "flex items-center gap-3 rounded-md border border-primary/40 bg-primary/5 p-3 text-xs", children: [
      /* @__PURE__ */ jsx10(Loader22, { className: "h-4 w-4 animate-spin shrink-0 text-primary" }),
      /* @__PURE__ */ jsxs9("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsx10("div", { className: "font-semibold text-primary", children: "Iniciando primera ronda\u2026" }),
        /* @__PURE__ */ jsx10("div", { className: "text-[11px] text-muted-foreground", children: "El AI est\xE1 leyendo tu feedback, los archivos adjuntos y los datos t\xE9cnicos. Esto tarda 60\u2013180 segundos en la primera ronda." })
      ] }),
      /* @__PURE__ */ jsx10(
        Button,
        {
    ...
    stream.state.providerFallback ? /* @__PURE__ */ jsxs9(
      "output",
      {
        "aria-live": "polite",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs9("div", { className: "flex-1 leading-relaxed", children: [
            /* @__PURE__ */ jsx10("span", { className: "font-semibold", children: "Cambio de modelo en vuelo." }),
            " Saturaci\xF3n temporal en",
            " ",
            /* @__PURE__ */ jsx10("code", { className: "rounded bg-amber-100 px-1 font-mono text-[10px] dark:bg-amber-900/40", children: stream.state.providerFallback.fromModel }),
            "; tu iteraci\xF3n la est\xE1 sirviendo",
            " ",
            /* @__PURE__ */ jsx10("code", { className: "rounded bg-amber-100 px-1 font-mono text-[10px] dark:bg-amber-900/40", children: stream.state.providerFallback.toModel }),
            " ",
    ...
    isComplete && sess?.completion_reason ? /* @__PURE__ */ jsxs9("p", { className: "rounded border border-emerald-200 bg-emerald-50 p-2 text-[11px] text-emerald-900", children: [
      /* @__PURE__ */ jsx10("strong", { className: "font-semibold", children: "Why ready: " }),
      sess.completion_reason
    ] }) : null,
    /* @__PURE__ */ jsx10(
      IterFocusShell,
      {
        sidebar: /* @__PURE__ */ jsx10(
          IterPendingSidebar,
          {
            openAssumptions,
        ...
        main: /* @__PURE__ */ jsxs9("div", { className: "flex h-full min-h-0 flex-col gap-3", children: [
          focused ? /* @__PURE__ */ jsx10(
            AssumptionCard,
            {
              assumption: focused,
              disabled: status === "finalized" || status === "abandoned",
          ...
          ) : status !== "finalized" && status !== "abandoned" ? (versions.data?.length ?? 0) > 0 ? /* @__PURE__ */ jsxs9(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx10("span", { "aria-hidden": "true", className: "mr-1.5", children: "\u2705" }),
                /* @__PURE__ */ jsx10("strong", { className: "font-semibold", children: "Todo respondido" }),
    ...
    (stream.state.errorMessage || streamBudgetExhausted) && stream.state.status === "error" ? /* @__PURE__ */ jsx10("div", { className: "rounded border border-amber-300 bg-amber-50 p-2 text-[11px] text-amber-900", children: streamBudgetExhausted ? "Has usado todas las rondas para este spec. Marca como listo o abandona la sesi\xF3n." : stream.state.errorMessage }) : null,
    status === "finalized" && pkgQuery.data?.presigned_zip_url ? /* @__PURE__ */ jsxs9("div", { className: "rounded-md border border-emerald-300 bg-emerald-50 p-3 text-xs text-emerald-900 space-y-2", children: [
      /* @__PURE__ */ jsx10("p", { className: "font-semibold", children: "Spec finalized \u2014 your package is ready." }),
      /* @__PURE__ */ jsx10(
        "a",
        {
          href: pkgQuery.data.presigned_zip_url,
      ...
      /* @__PURE__ */ jsx10("p", { className: "text-[10px] text-emerald-800/80", children: "You can also re-download anytime from the ticket card after returning to the feed." })
    ] }) : null,
    status !== "finalized" && status !== "abandoned" ? /* @__PURE__ */ jsxs9("footer", { className: "space-y-2 border-t border-input pt-3", children: [
      !turnBudgetSpent && !isComplete ? /* @__PURE__ */ jsx10(
        Textarea,
        {
          value: msg,
          onChange: (e) => setMsg(e.target.value),
      ...
      /* @__PURE__ */ jsxs9("div", { className: "flex flex-wrap items-center gap-2", children: [
        !turnBudgetSpent && !isComplete ? /* @__PURE__ */ jsx10(
          Button,
          {
            ...
            title: openAssumptions.length > 0 ? "Resolve the open assumption(s) first" : "Run the next iteration",
            children: isStreaming ? /* @__PURE__ */ jsxs9(Fragment2, { children: [
              /* @__PURE__ */ jsx10(Loader22, { className: "h-3.5 w-3.5 animate-spin" }),
              " Running\u2026"
            ] }) : "Run iteration"
          }
        ) : null,
...
function Canvas({
  ...
  const [iterByFeedback, setIterByFeedback] = useState7({});
  const [iterStartingId, setIterStartingId] = useState7(null);
  const [iterError, setIterError] = useState7(null);
  const [focusedFeedbackId, setFocusedFeedbackId] = useState7(null);
  const [tab, setTab] = useState7("compose");
  ...
  if (focusedFeedbackId && iterByFeedback[focusedFeedbackId]) {
    return /* @__PURE__ */ jsx11("div", { className: "h-full", children: /* @__PURE__ */ jsx11(
      IterFocusView,
      {
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "space-y-3", children: [
    ...
    ) : query.isLoading ? /* @__PURE__ */ jsx11("p", { className: "text-sm text-muted-foreground", children: t("feedback.mine.loading") }) : query.isError ? /* @__PURE__ */ jsx11("p", { className: "text-sm text-destructive", children: t("feedback.mine.error") }) : (query.data ?? []).length === 0 ? /* @__PURE__ */ jsx11("p", { className: "text-sm text-muted-foreground", children: t("feedback.mine.empty") }) : /* @__PURE__ */ jsx11("ul", { className: "space-y-2", children: (query.data ?? []).map((r) => {
        ...
        "li",
        {
          ...
          children: /* @__PURE__ */ jsxs10(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs10("div", { className: "w-full p-2 text-sm flex flex-col gap-1 hover:bg-accent rounded-md", children: [
                  /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxs10(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsx11("code", { className: "font-mono text-xs px-1 py-0.5 rounded bg-muted shrink-0", children: r.ticket_code || "\u2014" }),
                          /* @__PURE__ */ jsx11(Badge, { variant: statusVariant(r.status), className: "shrink-0", children: humanStatus(r.status) }),
                          /* @__PURE__ */ jsx11("span", { className: "truncate flex-1 font-medium", children: r.title }),
                          isOpen ? /* @__PURE__ */ jsx11(ChevronUp, { className: "h-3.5 w-3.5 shrink-0 text-muted-foreground" }) : /* @__PURE__ */ jsx11(ChevronDown2, { className: "h-3.5 w-3.5 shrink-0 text-muted-foreground" })
                        ]
                      }
                    ),
                    !iterSessionId && /* @__PURE__ */ jsxs10(
                      Button,
                      {
                        type: "button",
                        size: "sm",
                        ...
                        children: [
                          /* @__PURE__ */ jsx11(Sparkles2, { className: "h-3.5 w-3.5" }),
                          iterStartingId === r.id ? "Opening\u2026" : "Iterate"
                        ]
                      }
                    )
                  ] }),
                  recentlyResolved && !isOpen ? /* @__PURE__ */ jsx11("span", { className: "text-[11px] text-primary", children: t("feedback.mine.action_hint") }) : null
                ] }),
                isOpen ? /* @__PURE__ */ jsxs10(
                  "div",
                  {
                    ...
                    children: [
                      r.created_at ? /* @__PURE__ */ jsx11("p", { className: "text-muted-foreground", children: t("feedback.mine.submitted_at", {
                        date: r.created_at.slice(0, 16).replace("T", " ")
                      }) }) : null,
                      /* @__PURE__ */ jsxs10("section", { children: [
                        /* @__PURE__ */ jsx11("h4", { className: "font-semibold text-foreground mb-1", children: t("feedback.field.description") }),
                        /* @__PURE__ */ jsx11("p", { className: "whitespace-pre-wrap", children: r.description || /* @__PURE__ */ jsx11("span", { className: "italic text-muted-foreground", children: t("feedback.mine.no_description") }) })
                      ] }),
                      r.expected_outcome ? /* @__PURE__ */ jsxs10("section", { children: [
                        /* @__PURE__ */ jsx11("h4", { className: "font-semibold text-foreground mb-1", children: t("feedback.field.expected_outcome") }),
                        /* @__PURE__ */ jsx11("p", { className: "whitespace-pre-wrap", children: r.expected_outcome })
                      ] }) : null,
                      r.triage_note ? /* @__PURE__ */ jsxs10("section", { className: "rounded bg-muted/50 p-2", children: [
                        /* @__PURE__ */ jsx11("h4", { className: "font-semibold text-foreground mb-1", children: t("feedback.mine.triage_note") }),
                        /* @__PURE__ */ jsx11("p", { className: "whitespace-pre-wrap", children: r.triage_note })
                      ] }) : null,
                      r.attachments && r.attachments.length > 0 ? /* @__PURE__ */ jsxs10("section", { children: [
                        /* @__PURE__ */ jsx11("h4", { className: "font-semibold text-foreground mb-1", children: t("feedback.mine.attachments", {
                          count: String(r.attachments.length)
                        }) }),
                        /* @__PURE__ */ jsx11("ul", { className: "space-y-1.5", children: r.attachments.map((a) => {
                          ...
                          return /* @__PURE__ */ jsxs10(
                            "li",
                            {
                              className: "flex items-center gap-2 rounded border border-input bg-background p-1.5",
                              children: [
                                isImage && a.presigned_url ? /* @__PURE__ */ jsx11(
                                  "a",
                                  {
                                    href: a.presigned_url,
                                    target: "_blank",
                                ...
                                /* @__PURE__ */ jsx11("span", { className: "flex-1 truncate font-mono", children: label }),
                      ...
                      /* @__PURE__ */ jsx11(CommentThread, { feedbackId: r.id }),
                      iterSessionId && config.iterStyle === "inline" ? /* @__PURE__ */ jsx11(
                        InlineIterPane,
                        {
                      ...
                      ) : iterSessionId && config.iterStyle === "focus" ? /* @__PURE__ */ jsxs10(
                        Button,
                        {
                          size: "sm",
                      ...
                      iterError && iterStartingId === null ? /* @__PURE__ */ jsx11("p", { className: "text-xs text-destructive", children: iterError }) : null
                    ]
                  }
                ) : null
              ]
  ...
  return /* @__PURE__ */ jsxs11(
    "button",
    {
      ...
      children: [
        ...
        " ",
        /* @__PURE__ */ jsxs11("code", { className: "font-mono", children: [
          "fe v",
          VERSION,
          " \xB7 be v",
          beVersion
        ] }),
        !matched && beVersion !== "?" ? /* @__PURE__ */ jsx12("span", { className: "ml-1 text-amber-600/80", title: "Frontend and backend versions don't match", children: "\u26A0" }) : null,
        expanded ? /* @__PURE__ */ jsxs11("div", { className: "mt-1 mx-auto max-w-md rounded border border-input bg-card p-2 text-left font-mono text-[10px] leading-snug", children: [
          ...
          !matched && beVersion !== "?" ? /* @__PURE__ */ jsx12("div", { className: "mt-1 text-amber-700", children: "\u26A0 Versiones distintas \u2014 refresca el navegador y/o reconstruye el backend." }) : null
        ] }) : null
      ]
    }
  );
...
function FeedbackPanel({
  ...
  return /* @__PURE__ */ jsx13(Sheet, { open, onOpenChange, children: /* @__PURE__ */ jsxs12(
    SheetContent,
    {
      side: "right",
      ...
      children: [
        !isFocused ? /* @__PURE__ */ jsxs12(SheetHeader, { children: [
          /* @__PURE__ */ jsxs12(SheetTitle, { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx13(Rl3Mark, { className: "h-6 w-6 shrink-0" }),
            /* @__PURE__ */ jsx13("span", { children: t("feedback.panel_title") })
          ] }),
          /* @__PURE__ */ jsx13(SheetDescription, { children: t("feedback.panel_description") })
        ] }) : null,
        /* @__PURE__ */ jsxs12("div", { className: `flex-1 min-h-0 ${isFocused ? "p-3 sm:p-4" : "px-4 mt-4"}`, children: [
          /* @__PURE__ */ jsx13(
            Canvas,
            {
              locked,
          ...
          !isFocused ? /* @__PURE__ */ jsxs12(Fragment3, { children: [
            /* @__PURE__ */ jsxs12(
              "a",
              {
                href: "https://rl3.dev",
                ...
                children: [
                  /* @__PURE__ */ jsx13(Rl3Mark, { className: "h-3.5 w-3.5" }),
                  /* @__PURE__ */ jsxs12("span", { children: [
                    t("feedback.powered_by"),
                    " ",
                    /* @__PURE__ */ jsx13("strong", { className: "font-semibold", children: "RL3" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsx13(VersionPill, {})
          ] }) : null
        ] }),
        !isFocused ? /* @__PURE__ */ jsx13(SheetFooter, { className: "mt-4", children: /* @__PURE__ */ jsx13(
          Button,
          {
            variant: "outline",
