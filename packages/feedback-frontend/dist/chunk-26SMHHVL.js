...
function CommentThread({ feedbackId }) {
  ...
  return /* @__PURE__ */ jsxs4("section", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxs4("div", { className: "space-y-1.5", children: [
      ...
      /* @__PURE__ */ jsx6("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxs4(
        Button,
        {
          type: "button",
          size: "sm",
...
//# sourceMappingURL=chunk-26SMHHVL.js.map